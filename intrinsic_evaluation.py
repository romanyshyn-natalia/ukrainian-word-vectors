...
def analogy_evaluation(models_path, analogies, first_n, file_out):
    """
    Compute performance of the model on an analogy word_analogies set and writes results to a file.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--questions", type=pathlib.Path, help="Path to the file with word_analogies questions",
                        default=pathlib.Path("word_analogies/test_vocabulary.txt"))
